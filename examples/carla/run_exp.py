...
def main(main_args):
	...
	target_maker_args['meas_to_predict'] = [12,14] # collision and speed
	...
	test_policy_experience_args['memory_capacity'] = 2000
		
	## Agent	
	agent_args = {}
	# agent type
	agent_args['agent_type'] = 'advantage'
	agent_args['carla'] = True
